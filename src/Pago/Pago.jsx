    ...
    <div className="pago-container">
      ...
      <main className="pago-main">
        <div className="pago-image-placeholder">
          {referenciaData ? (
            <div className="referencia-info">
              ...
              <p><strong>Número de Cuenta:</strong> {referenciaData.numCuenta}</p>
              <p><strong>Titular:</strong> {referenciaData.duenoCuenta}</p>
              <p><strong>Clave Interbancaria:</strong> {referenciaData.clabeBanco}</p>
            </div>
          ) : (
        ...
        <div className="pago-instruction">
          ...
          <a href="https://wa.me/qr/GQZKNWIDQ5B4I1" target="_blank" rel="noopener noreferrer">
