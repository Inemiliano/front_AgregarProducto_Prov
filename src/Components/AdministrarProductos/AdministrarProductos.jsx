...
const ProductForm = ({ onProductAdded }) => {
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
        ...
        return response.data.filename; // <-- Asegúrate de que estás obteniendo el nombre del archivo
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!imageUrl) return; // Maneja el error si la carga de la imagen falló
